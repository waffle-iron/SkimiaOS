...
namespace SkimiaOS.Core.Config
{
    public class ConfigNode
    {
        ...
        public ConfigNode(XmlNode node)
        {
            ...
            this.ClassName = ConfigNode.GetClassNameFromNode(node);
            this.Namespace = ConfigNode.GetNamespaceFromNode(node);
            this.Documentation = ConfigNode.FindDescription(node);
            this.Instance = null;
        }

        public ConfigNode(FieldInfo field)
        {
        ...
        public ConfigNode(PropertyInfo property)
        {
        ...
        public void BindToField(FieldInfo fieldInfo)
        {
            ...
            this.Attribute = fieldInfo.GetCustomAttribute<ConfigurableAttribute>();
        ...
        public void BindToProperty(PropertyInfo propertyInfo)
        {
            ...
            this.Attribute = propertyInfo.GetCustomAttribute<ConfigurableAttribute>();
            if (this.Attribute == null)
            {
